...
HD_PWD='D:/Games/Verilog/11_sem/FIFO_Arty7/My_FIFO.runs/MyFIFO_vio_FIFO_wrapper_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MyFIFO_vio_FIFO_wrapper_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MyFIFO_vio_FIFO_wrapper_0_0.tcl
