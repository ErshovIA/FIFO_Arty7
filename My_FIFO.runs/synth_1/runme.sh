...
HD_PWD='D:/Games/Verilog/11_sem/FIFO_Arty7/My_FIFO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MyFIFO_vio_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MyFIFO_vio_wrapper.tcl
