...
HD_PWD='D:/Games/Verilog/11_sem/FIFO_Arty7/My_FIFO.runs/FIFO_wrapped_VIO_vio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_wrapped_VIO_vio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFO_wrapped_VIO_vio_0_0.tcl
